...
import createReducer, { REHYDRATE_COMPLETE } from '../redux/indexReducer';
import rootSagas from '../redux/indexSaga';
import migrations from './migrations';

const sagaMiddleware = createSagaMiddleware();
const authenticationFilter = createFilter('auth');
const pageFilter = createFilter('page.tempPageContent');
...
export default function configureStore(initialState = {}, history) {
    ...
    if (module.hot) {
        module.hot.accept(['../redux/indexReducer', '../redux/indexSaga'], () => {
